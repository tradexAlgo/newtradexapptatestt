...
// 
  ...
  const tradingViewHTML = (symbol) => `
  <!DOCTYPE html>
  <html>
    <head>
      <meta charset="utf-8">
      <meta name="viewport" content="width=device-width, initial-scale=1.2, maximum-scale=2.0, user-scalable=no" />
      <style>
        html, body {
          margin: 0;
          padding: 0;
    ...
    <>
      {loading ? (
        ...
        <SafeAreaView style={styles.container}>
          ...
          <WebView
            originWhitelist={['*']}
            source={{ html: tradingViewHTML(symbol) }}
            style={{ flex: 1 }}
